...
public class GiftDetailActivity extends BaseActivity implements IXListViewListener,OnItemClickListener{
	...
	private void clickfavorite(){
		HttpUtils.clickfavorite(new HttpErrorHandler() {
			...
			public void onRecevieSuccess(JSONObject json) {
				...
				Tools.toast(GiftDetailActivity.this, msg_dw_laud.isChecked()?"点赞成功":"取消点赞");
			}
			@Override
	...
	private void clickCollect(){
		HttpUtils.clickCollect(new HttpErrorHandler() {
			...
			public void onRecevieSuccess(JSONObject json) {
				...
				Tools.toast(GiftDetailActivity.this, msg_dw_star.isChecked()?"收藏成功":"取消收藏");
			}
			@Override
			public void onRecevieFailed(String status, JSONObject json) {
	...
	class TimeCount extends CountDownTimer {
		...
		public void onTick(long millisUntilFinished){//计时过程显示
			...
			gift_message.setText("恭喜你，浏览"+seconds+"秒之后将会获得商家红包"+good.getString("goods_price")+"元！");
		}
	}
}
